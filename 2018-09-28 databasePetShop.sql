...
INSERT INTO `participant` VALUES (1,'airmail@petshop.ru','The first user');
...
INSERT INTO `session` VALUES (1,'PHP_Genius','2018-09-28 12:00:00','Description of PHP Genius Course');
...
CREATE TABLE `session_participant` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_idx` (`participant_id`),
  KEY `id_idx1` (`session_id`),
  CONSTRAINT `id` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `speaker` VALUES (1,'Watson'),(2,'Arnold');
...
-- Dump completed on 2018-09-28  7:39:24
